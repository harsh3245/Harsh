...
contract Token
{
	...
	function balance_check(address owner) const returns (uint total);
...
contract Key
{
	...
	function key_selection(address Sender) const returns (bytes32 key)
	...
	function receive_key(address owner_account, address sender_address,uint amount)
	{
